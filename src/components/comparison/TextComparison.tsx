      ...
      <div className="p-4">
        {activeTab === 'enhanced' && (
          ...
          >
            ...
            <div className="mt-2">
              ...
              {isGeneratingAI ? (
                <div className="flex items-center justify-center p-8 bg-purple-50 rounded-lg dark:bg-purple-900">
                  <Loader className="animate-spin h-6 w-6 text-purple-600 mr-2" />
                  <span className="text-purple-700 dark:text-purple-300">Generating comprehensive AI analysis...</span>
                </div>
              ) : error ? (
                renderErrorMessage()
              ) : aiSummary ? (
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 dark:bg-purple-900 dark:border-purple-700">
                  <div className="prose max-w-none">
                    {aiSummary.split('\n').map((paragraph, index) => (
                      <p key={index} className="my-3 text-purple-900 leading-relaxed dark:text-purple-200">
                        {paragraph}
                      </p>
                    ))}
                  </div>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 text-center dark:bg-purple-950 dark:border-purple-700">
                  <Sparkles className="h-8 w-8 text-purple-400 mx-auto mb-2 dark:text-purple-300" />
                  <p className="text-purple-800 text-sm font-medium mb-2 dark:text-purple-200">
        ...
        {activeTab === 'original' && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
          >
            <div className="bg-blue-50 p-2 rounded-md mb-4 text-sm text-blue-800 flex items-center dark:bg-blue-950 dark:text-blue-200">
            ...
            {isLoading ? (
              <div className="flex items-center justify-center p-8">
                ...
                <span className="text-gray-600 dark:text-gray-300">Loading bill text...</span>
              </div>
            ) : error ? (
              renderErrorMessage()
            ) : originalText ? (
              <>
                <div className="font-mono text-sm whitespace-pre-line bg-gray-50 p-4 rounded-md overflow-auto dark:bg-gray-700 dark:text-gray-200">
                  {displayOriginalText}
                </div>
                ...
                {originalParagraphs.length > 3 && (
                  <button 
                    ...
                    className="mt-3 text-primary-600 hover:text-primary-800 text-sm font-medium flex items-center dark:text-primary-400 dark:hover:text-primary-300"
                  >
                    {showFullOriginal ? (
                      <>
        ...
        {activeTab === 'side-by-side' && (
          ...
          >
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-2 dark:text-gray-300">Bill Text</h4>
              {isLoading ? (
                <div className="flex items-center justify-center p-8 bg-gray-50 rounded-md dark:bg-gray-700">
                  <Loader className="animate-spin h-6 w-6 text-primary-600 mr-2" />
                ...
                <div className="font-mono text-sm whitespace-pre-line bg-gray-50 p-3 rounded-md overflow-auto h-[400px] dark:bg-gray-700 dark:text-gray-200">
            ...
            <div>
              <h4 className="text-sm font-medium text-gray-700 mb-2 dark:text-gray-300">Enhanced AI Analysis</h4>
              <div className="prose max-w-none bg-purple-50 p-3 rounded-md overflow-auto h-[400px] text-sm dark:bg-purple-900">
                {aiSummary ? (
                  aiSummary.split('\n').map((paragraph, index) => (
                    <p key={index} className="my-2 text-purple-900 dark:text-purple-200">{paragraph}</p>
                  ))
                ) : (
                  <div className="flex flex-col items-center justify-center h-full">
                    <Sparkles className="h-6 w-6 text-purple-400 mb-2 dark:text-purple-300" />
                    <p className="text-purple-800 text-sm font-medium dark:text-purple-200">
