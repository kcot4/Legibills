              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h3 className="font-semibold text-gray-900 mb-1">Reporting Issue For:</h3>
                          ...
                          <div className="flex items-start space-x-3 w-full">
                            ...
                            <div className="flex-1">
                              <div className={`font-medium ${
                                selectedCategory === option.value ? 'text-red-900' : 'text-gray-900'
                              }`}>
                                {option.label}
                              </div>
                              <div className={`text-sm mt-1 ${
                                selectedCategory === option.value ? 'text-red-700' : 'text-gray-600'
                              }`}>
                                {option.description}
                              </div>
                            </div>
