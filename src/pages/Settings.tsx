...
const Settings: React.FC = () => {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2 dark:text-white">Settings</h1>
      ...
      <div className="space-y-6">
        ...
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Receive updates about tracked bills</p>
              </div>
              ...
              >
                ...
                <div className="flex">
                  <input
                    ...
                    className="flex-1 rounded-l-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:text-white dark:placeholder-gray-400"
                  />
                  <button
            ...
            <div className="flex items-center justify-between py-3 border-t border-gray-200 dark:border-gray-700">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Get a summary of legislative updates</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
        ...
        <section className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 dark:bg-gray-800 dark:border-gray-700">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3">
              <div>
                <h3 className="text-sm font-medium text-gray-900 dark:text-white">Usage Analytics</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Help improve the app with anonymous usage data</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Remove all saved preferences and tracked bills</p>
              </div>
              <button
