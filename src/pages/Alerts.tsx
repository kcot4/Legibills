    ...
    <div>
      ...
      <section className="mb-8">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-900">Topic Alerts</h2>
          <button
        ...
        {isAddingTopic ? (
          ...
          >
            <h3 className="text-sm font-medium text-gray-700 mb-3">Select topics to track:</h3>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-4">
            {selectedTopics.length === 0 ? (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No topics selected</h3>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {selectedTopics.map(topic => (
                    <span
                      key={topic}
                      className="inline-flex items-center bg-primary-50 text-primary-700 rounded-full px-3 py-1 text-sm font-medium"
                    >
                      {topic}
                    </span>
                  ))}
      ...
      {/* Bill Alerts */}
      <section className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Bill Alerts</h2>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          {trackedBills.length === 0 ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No bills tracked</h3>
              <p className="text-gray-500 mb-4">
                ...
                {trackedBills.map(bill => (
                  <li key={bill.id} className="py-4 flex justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-500 truncate max-w-lg">{bill.title}</p>
                    </div>
                    <button
      ...
      <section>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            >
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 block w-full rounded-l-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                />
                <button
                  type="button"
                  onClick={saveEmail}
          ...
          <div className="flex items-center justify-between py-4">
            <div>
              <h3 className="text-lg font-medium text-gray-900">Urgency Alerts</h3>
              <p className="text-sm text-gray-500">
