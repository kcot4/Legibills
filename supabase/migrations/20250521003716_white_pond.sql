/*
  # Add source tracking for bill text
  
  1. Changes
    - Add text_source column to bills table to track where the text came from
    - Add text_updated_at column to track when the text was last updated
  
  2. Notes
    - Helps track text freshness and source for debugging
